...
namespace EgtDemo.Tasks
{
    public class Job_Blogs_Quartz :  IJob
    {
        ...
        public Job_Blogs_Quartz(IDemoServ demoServ, ITasksQzServices tasksQzServices)
        {
            _demoServ = demoServ;
        ...
        public async Task Run(IJobExecutionContext context, int jobid)
        {
            ...
            await Console.Out.WriteLineAsync("name" + list.name);
        }
